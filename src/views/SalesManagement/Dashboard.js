...
const cardChartData5 = {
  ...
  datasets: [
    {
      label: 'My First dataset',
      backgroundColor: 'rgba(45, 30, 115,.3)',
      borderColor: 'transparent',
    ...
    return (
      <div className="animated fadeIn">
                    ...
                    <Row>
                      <Col xs="12" sm="6" xl="3">
                        ...
                        <div className="callout callout-info">
                         ...
                         <hr></hr>
                         <small className="text-muted">13% INCREASE</small>
                        </div>
                      </Col>
                      <Col xs="12" sm="6" xl="3">
                        <div className="callout callout-danger">
                          ...
                          <hr></hr>
                         <small className="text-muted">4% INCREASE</small>
                        </div>
                      </Col>
                      ...
                      <Col xs="12" sm="6" xl="3">
                        <div className="callout callout-info">
                          ...
                          <hr></hr>
                         <small className="text-muted">21% INCREASE</small>
                        </div>
                      </Col>

                      <Col xs="12" sm="6" xl="3">
                        <div className="callout callout-info">
                          <small className="text-muted">Profits</small>
                          <br />
                          <strong className="h4">9,123</strong>
                          <div className="chart-wrapper">
                            <Line data={makeSparkLineData(0, brandPrimary)} options={sparklineChartOpts} width={100} height={30} />
        ...
        <Col xs="12" sm="6" lg="4">
          ...
          <Line data={cardChartData5} options={cardChartOpts3} height={70} />
          </CardBody>
          </Card>
          </Col>
          ...
          <Card>
            <CardBody>
            <Pie data={cardChartData5} options={cardChartOpts4} height={70}/>
            </CardBody>
          </Card>
            </Col>
            {/* <Card>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                ...
                <div className="text-value">$9,587</div>
                <div>Sales</div>
              </CardBody>
